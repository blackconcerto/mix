...
(function( zepto, $, undefined ) {
     ...
     * @param {Object} [options] 组件配置项。具体参数请查看[Options](#zepto:Dialog:options)
     * @grammar $( el ).dialog( options ) => zepto
     * @grammar new zepto.Dialog( el, options ) => instance
     */
    zepto.define( 'Dialog', {
        options: {
            /**
        ...
        _init: function(){
            ...
            me.on( 'ready', function() {
                ...
                if (typeof(opts.createdCallback) == 'function'){
                    opts.createdCallback();
                }
        ...
        close: function(){
            ...
            $(document.body).css("overflow","visible !important");
            $("html").css("overflow","visible !important");
